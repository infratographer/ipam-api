...
type IPAddressFunc func(context.Context, *generated.IPAddressMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f IPAddressFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.IPAddressMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.IPAddressMutation", m)
}

// The IPBlockFunc type is an adapter to allow the use of ordinary
// function as IPBlock mutator.
type IPBlockFunc func(context.Context, *generated.IPBlockMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f IPBlockFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.IPBlockMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.IPBlockMutation", m)
}

// The IPBlockTypeFunc type is an adapter to allow the use of ordinary
// function as IPBlockType mutator.
type IPBlockTypeFunc func(context.Context, *generated.IPBlockTypeMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f IPBlockTypeFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.IPBlockTypeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.IPBlockTypeMutation", m)
}
