...
func (tx *Tx) init() {
	...
	tx.IPBlock = NewIPBlockClient(tx.config)
	tx.IPBlockType = NewIPBlockTypeClient(tx.config)
}
...
// applies a query, for example: IPAddress.QueryXXX(), the query will be executed
