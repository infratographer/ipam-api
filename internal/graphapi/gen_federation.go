...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "IPAddress":
			resolverName, err := entityResolverNameForIPAddress(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "IPAddress": %w`, err)
			}
			switch resolverName {
			...
			case "findIPAddressByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findIPAddressByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindIPAddressByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "IPAddress": %w`, err)
				}
		...
		case "IPBlock":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "IPBlock": %w`, err)
			}
			switch resolverName {
			...
			case "findIPBlockByID":
				id0, err := ec.unmarshalNID2goᚗinfratographerᚗcomᚋxᚋgidxᚐPrefixedID(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findIPBlockByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindIPBlockByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "IPBlock": %w`, err)
				}
		...
		case "IPBlockType":
			resolverName, err := entityResolverNameForIPBlockType(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "IPBlockType": %w`, err)
			}
			switch resolverName {
			...
			case "findIPBlockTypeByID":
				id0, err := ec.unmarshalNID2goᚗinfratographerᚗcomᚋxᚋgidxᚐPrefixedID(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findIPBlockTypeByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindIPBlockTypeByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "IPBlockType": %w`, err)
				}
...
func entityResolverNameForIPAddress(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
...
func entityResolverNameForIPBlock(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		...
		return "findIPBlockByID", nil
	}
	return "", fmt.Errorf("%w for IPBlock", ErrTypeNotFound)
}

func entityResolverNameForIPBlockType(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
		...
		return "findIPBlockTypeByID", nil
	}
	return "", fmt.Errorf("%w for IPBlockType", ErrTypeNotFound)
}
